...
import breakfast from '../assets/images/FalaiseFoerignMeal/food17.jpg';
import international1 from '../assets/images/FalaiseFoerignMeal/food14.jpg';
import international2 from '../assets/images/FalaiseFoerignMeal/food15.jpg';
import international3 from '../assets/images/FalaiseFoerignMeal/food16.jpg';
...
export function Services(){
  return(
    <div className="h-75 w-full bg-[#C9B5A5] p-10 grid grid-cols-2">
      {/* first grid */}
      ...
      <div className="mb-10">
        <div className="flex items-center">
       <div><Heart color="brown" size={30}/></div>
