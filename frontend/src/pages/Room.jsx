...
import  room6 from '../assets/images/room4lafalaise.webp';

import  room7 from '../assets/images/FalaiseRooms/LaFalaiseroom10.jpg';

import  room10 from '../assets/images/room7lafalaise.webp';

export function Room(){
  return(
    <div id='room' className="h-150 w-full bg-[#E8DED4]  p-8 ">
